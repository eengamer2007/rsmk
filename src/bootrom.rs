...
const bootrom_LOOKUP_A2: *const u16 = ROM_TABLE_LOOKUP_A2;
...
const bootrom_LOOKUP_A1: *const u32 = ROM_TABLE_LOOKUP_A1;
...
const bootrom_LOOKUP_A2: *const u16 = 0x0000_7DF8 as _;
...
const bootrom_LOOKUP_A1: *const u32 = 0x0000_7DF4 as _;
...
pub fn bootrom_lookup(tag: RomFnTableCode, mask: u32) -> usize {
    let tag = u16::from_le_bytes(tag) as u32;

    unsafe {
        let lookup_func = if rom_version_number() == 1 {
            bootrom_LOOKUP_A1.read() as usize
        } else {
            bootrom_LOOKUP_A2.read() as usize
        };
...
declare_rom_function! {
    ...
    unsafe fn connect_internal_flash() -> () {
        ...
        crate::bootrom::rom_table_lookup(*b"IF", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    unsafe fn flash_exit_xip() -> () {
        ...
        crate::bootrom::rom_table_lookup(*b"EX", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    unsafe fn flash_range_erase(addr: u32, count: usize, block_size: u32, block_cmd: u8) -> () {
        ...
        crate::bootrom::rom_table_lookup(*b"RE", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    unsafe fn flash_range_program(addr: u32, data: *const u8, count: usize) -> () {
        ...
        crate::bootrom::rom_table_lookup(*b"RP", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    unsafe fn flash_flush_cache() -> () {
        ...
        crate::bootrom::rom_table_lookup(*b"FC", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    unsafe fn flash_enter_cmd_xip() -> () {
        ...
        crate::bootrom::rom_table_lookup(*b"CX", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    unsafe fn flash_select_xip_read_mode(bootrom_xip_mode: u8, clkdiv: u8) -> () {
        ...
        crate::bootrom::rom_table_lookup(*b"XM", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    unsafe fn flash_reset_address_trans() -> () {
        ...
        crate::bootrom::rom_table_lookup(*b"RA", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    unsafe fn flash_runtime_to_storage_addr(addr: u32) -> i32 {
        ...
        crate::bootrom::rom_table_lookup(*b"FA", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    unsafe fn flash_runtime_to_storage_addr_ns(addr: u32) -> i32 {
        ...
        crate::bootrom::rom_table_lookup(*b"FA", crate::bootrom::rt_flags::FUNC_ARM_NONSEC)
...
declare_rom_function! {
    ...
    unsafe fn flash_op(flags: u32, addr: u32, size_bytes: u32, buffer: *mut u8) -> i32 {
        ...
        crate::bootrom::rom_table_lookup(*b"FO", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    unsafe fn flash_op_ns(flags: u32, addr: u32, size_bytes: u32, buffer: *mut u8) -> i32 {
        ...
        crate::bootrom::rom_table_lookup(*b"FO", crate::bootrom::rt_flags::FUNC_ARM_NONSEC)
...
declare_rom_function! {
    ...
    unsafe fn set_ns_api_permission(ns_api_num: u32, allowed: u8) -> i32 {
        ...
        crate::bootrom::rom_table_lookup(*b"SP", crate::bootrom::rt_flags::FUNC_ARM_SEC)
...
declare_rom_function! {
    ...
    unsafe fn validate_ns_buffer() -> () {
        ...
        crate::bootrom::rom_table_lookup(*b"VB", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    fn reboot(flags: u32, delay_ms: u32, p0: u32, p1: u32) -> i32 {
        ...
        crate::bootrom::rom_table_lookup(*b"RB", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    fn reboot_ns(flags: u32, delay_ms: u32, p0: u32, p1: u32) -> i32 {
        ...
        crate::bootrom::rom_table_lookup(*b"RB", crate::bootrom::rt_flags::FUNC_ARM_NONSEC)
...
declare_rom_function! {
    ...
    unsafe fn bootrom_state_reset(flags: u32) -> () {
        ...
        crate::bootrom::rom_table_lookup(*b"SR", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    unsafe fn set_rom_callback(callback_number: i32, callback_fn: *const ()) -> i32 {
        ...
        crate::bootrom::rom_table_lookup(*b"RC", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    unsafe fn get_sys_info(out_buffer: *mut u32, out_buffer_word_size: usize, flags: u32) -> i32 {
        ...
        crate::bootrom::rom_table_lookup(*b"GS", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    unsafe fn get_sys_info_ns(out_buffer: *mut u32, out_buffer_word_size: usize, flags: u32) -> i32 {
        ...
        crate::bootrom::rom_table_lookup(*b"GS", crate::bootrom::rt_flags::FUNC_ARM_NONSEC)
...
declare_rom_function! {
    ...
    unsafe fn get_partition_table_info(out_buffer: *mut u32, out_buffer_word_size: usize, flags_and_partition: u32) -> i32 {
        ...
        crate::bootrom::rom_table_lookup(*b"GP", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    unsafe fn get_partition_table_info_ns(out_buffer: *mut u32, out_buffer_word_size: usize, flags_and_partition: u32) -> i32 {
        ...
        crate::bootrom::rom_table_lookup(*b"GP", crate::bootrom::rt_flags::FUNC_ARM_NONSEC)
...
declare_rom_function! {
    ...
    unsafe fn load_partition_table(workarea_base: *mut u8, workarea_size: usize, force_reload: bool) -> i32 {
        ...
        crate::bootrom::rom_table_lookup(*b"LP", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    unsafe fn otp_access(buf: *mut u8, buf_len: usize, row_and_flags: u32) -> i32 {
        ...
        crate::bootrom::rom_table_lookup(*b"OA", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    unsafe fn otp_access_ns(buf: *mut u8, buf_len: usize, row_and_flags: u32) -> i32 {
        ...
        crate::bootrom::rom_table_lookup(*b"OA", crate::bootrom::rt_flags::FUNC_ARM_NONSEC)
...
declare_rom_function! {
    ...
    unsafe fn pick_ab_parition(workarea_base: *mut u8, workarea_size: usize, partition_a_num: u32) -> i32 {
        ...
        crate::bootrom::rom_table_lookup(*b"AB", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    unsafe fn chain_image(workarea_base: *mut u8, workarea_size: usize, region_base: i32, region_size: u32) -> i32 {
        ...
        crate::bootrom::rom_table_lookup(*b"CI", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    unsafe fn explicit_buy(buffer: *mut u8, buffer_size: u32) -> i32 {
        ...
        crate::bootrom::rom_table_lookup(*b"EB", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    unsafe fn get_uf2_target_partition(workarea_base: *mut u8, workarea_size: usize, family_id: u32, partition_out: *mut u32) -> i32 {
        ...
        crate::bootrom::rom_table_lookup(*b"GU", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    unsafe fn get_b_partition(partition_a: u32) -> i32 {
        ...
        crate::bootrom::rom_table_lookup(*b"GB", crate::bootrom::rt_flags::FUNC_ARM_SEC_RISCV)
...
declare_rom_function! {
    ...
    unsafe fn set_bootrom_stack(base_size: *mut u32) -> i32 {
        ...
        crate::bootrom::rom_table_lookup(*b"SS", crate::bootrom::rt_flags::FUNC_RISCV)
...
pub fn git_revision() -> u32 {
    let ptr = bootrom_lookup(*b"GR", rt_flags::DATA) as *const u32;
...
pub fn partition_table_pointer() -> *const u32 {
    let ptr = bootrom_lookup(*b"PT", rt_flags::DATA) as *const *const u32;
